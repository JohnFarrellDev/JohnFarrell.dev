...
export const Introduction = () => {
  return (
    <>
      <p>
        First I need to mention how much I love UserScripts. As the client when
        visiting a website you are in control of your personal view and how you
        interact with the website. Userscripts are a way to inject your own
      ...
      <p>
        ...
        allows you to search for scripts for popular websites,{' '}
        <Link href="https://greasyfork.org">Greasy Fork</Link>
        is an online host of UserScripts that can easily be installed. When
        installing someone elses code it is your responsibility to understand
