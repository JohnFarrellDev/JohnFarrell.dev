      ...
      <section className="blog-page">
        <div className="section-center">
          ...
          <ul className={styles.list}>
            ...
            <p>
              Most of the time when a player is able to with certainty uncover a cell knowing it is not a bomb or place
              a flag on a cell as they know it is a bomb they are utilising{' '}
