...
export default function AboutMe() {
  return (
    <section className="min-h-[calc(100vh-5rem-9rem)] bg-gray-50 py-4">
          ...
          <div className="block gap-[50px] lg:flex">
            ...
            <div>
              <p className="leading-8">
                Hi, I'm John Farrell, a professional software engineer. I started programming in 2016 by teaching myself
                a little bit of coding following the completion of my BSc in Biomedical Science. It became my ambition
                to become a software engineer, so I enrolled in a master's degree in Computer Science at the University
                of Kent. After graduating, I worked at{' '}
                ...
                <a href="https://www.linkedin.com/showcase/caci-information-intelligence-group/" className="underline">
                  CACI IIG
                </a>{' '}
