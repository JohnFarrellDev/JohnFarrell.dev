...
export default function AdventOfCode2023() {
  return (
    <section className="page-center">
      <Title title="Advent of Code 2023" underlineClassName="bg-orange-400" />
      <Banner
        type="information"
        message={
          <>
            The company I work for (<a href="https://www.bjss.com">BJSS</a>) is a sponsor this year, we are hiring for a
            range of positions and skill levels so if you are interested in working at a tech consultancy with
      ...
      <p>
        ...
        input against a variable. I will then apply some parsing to extract the input data into a more usable format. I
        will then create a function for each of part 1 and part 2.
      </p>
