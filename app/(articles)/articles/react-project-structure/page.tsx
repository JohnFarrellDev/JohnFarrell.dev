...
export default function ReactProjectStructure() {
  return (
    <section className="page-center">
      <Title title="How I Like to Organise my React Projects" underlineClassName="bg-orange-400" />
      ...
      <p>
        ...
        this page. This is page based organisation, any React developer should be able to look at the page route and in
        turn, find the relevant component quickly.
      </p>
      ...
      <p>
        ...
        component. As both of these components are used in multiple places it doesn't make sense for them to be located
        in Components/Articles/ReactProjectStructure.
      </p>
      ...
      <p>
        ...
        styling (CSS), tests and storybook files next to it. This makes it quicker to find associated files when working
        on a component.
      </p>
      ...
      <p>
        Some of you might be saying that's fine but if you just changed the name of TableOfContents.tsx to index.tsx the
        imports would still be "clean" and you could remove the index.ts file. Removing the index.ts file could be nice
        as you might see it as unnecessary boilerplate.
      </p>

      <p>
        My issue with this approach is that you end up with hundreds of components that are not accurately represented
        by their filename, worse they all share the same filename index.tsx. This can make searching by file name a less
        smooth experience.
      </p>

      <p>
        Below is a screenshot from VS Code on a previous project I worked on before I came up with this system (whoops).
        I want to quickly go to a component called Location, it should be shown as the first choice. Because the
        filename is index.tsx it is hidden below our CSS and StoryBook files. This project was also small so the only
        index.tsx file being displayed is the correct file for the component we want.
      </p>
      ...
      <p>
        As projects grow larger your IDE will find many potential files all called index.tsx. I want to be able to type
        the component name, hit enter and the code is there, I don't want to be scanning through the file list, looking
        at the whole path to figure out which one is correct. The screenshot below shows that when the file name
        represents the actual component it is the first choice shown to the user.
      </p>
