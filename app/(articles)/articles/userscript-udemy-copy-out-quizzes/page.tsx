        ...
        <article>
          ...
          <div className="article-content">
            ...
            <p>
              ...
              <a href="https://www.userscript.zone/">userscript.zone</a> allows you to search for scripts by website
              name, <a href="https://greasyfork.org">Greasy Fork</a> is an online host of UserScripts that can easily be
            ...
            <p>
              ...
              <a href="https://en.wikipedia.org/wiki/Spaced_repetition">Spaced Repetition Learning</a> (SRL) app. SRL
              isn't a service offered on the Udemy platform. (<a href="https://www.udemy.com/">Udemy</a> is an online
              education platform)
            </p>
            <p>
            ...
            <p>
              ...
              <a href="https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver">Mutation Observer</a> class
              for the first time. Initially, when I first wrote this code I was utilising setTimeout and setInterval
              which felt hacky, I am far happier with the Mutation Observer implementation and it was a good tool to
              learn about.
            </p>
            <p>
            ...
            <p>
              When doing something like this I often think about the classic <a href="https://xkcd.com/">XKCD</a> for
              time saved vs time spent. I think it is important to also value the learning experience, if I ever need to
              do something like this again I could now do it very quickly.
            </p>
            <Image
