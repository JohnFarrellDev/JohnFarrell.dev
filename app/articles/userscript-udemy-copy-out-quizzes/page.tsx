  ...
  return (
    <section className="pt-20">
      ...
      <div className="page-center">
        ...
        <p>
          I have published both of these scripts to <Link href="https://greasyfork.org">Greasy Fork</Link>. The benefit
          of this is ease of installation and any changes I push to GitHub should be automatically picked up by Greasy
          Fork.
        </p>
        <p>
