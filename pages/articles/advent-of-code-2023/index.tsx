    ...
    <Layout>
      ...
      <section className="blog-page">
        ...
        <div className="section-center">
          <Banner
            ...
            message={
              <>
                ...
                for a range of positions and skill levels so if you are interested in working at a tech consultancy with
          ...
          <p>
            I will be using <strong>TypeScript</strong> to solve the puzzles as this is my strongest lanuage and I have
          ...
          <p>
            ...
            input against a variable. I will then apply some parsing to extract the input data into a more usable
