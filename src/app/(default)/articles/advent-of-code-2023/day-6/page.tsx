      ...
      <PageContentContainer as="article">
        <ArticleStyles>
          ...
          <p>
            ...
            boat's speed increases by 1 mm per millisecond. However, a timer starts counting down as soon as the button
            is pressed. Therefore, holding the button for an extended period could increase the distance traveled, but
            holding it for too long could leave the boat without enough time to cover the required distance. The task
            was to determine how many different times exist at which holding the button down for that duration would
            result in the boat traveling a greater distance than the associated target distance.
          </p>

          <h3>Part 1</h3>

          <p>
            For Part 1 of the solution, our goal is to determine how frequently the boat can travel a greater distance
            for each given time-distance pair input, and then multiply all the results together.
          </p>
          ...
          <p>
            ...
            increasing by 1 with each iteration. During this iteration, we calculated whether the distance traveled
            would exceed the given distance in the input. If it did, we incremented a counter associated with the
            corresponding object in the array. This basic solution effectively determined how many times the boat could
          ...
          <p>
            ...
            represents the total number of valid solutions for the duration the boat's button could be held. This
            approach leverages the certainty that all values between the minimum and maximum are valid, while those
