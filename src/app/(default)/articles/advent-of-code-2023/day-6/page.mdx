...
to determine how many different times exist at which holding the button down for that duration would result
in the boat traveling a greater distance than the associated target distance.
...
([wikipedia article on quadratic formula](https://en.wikipedia.org/wiki/Quadratic_formula))
...
![wolfram alpha graph showing a quadratic equation](https://personal-website-sfdajkfsadvvujfdsfyeusjhvbsdfhfdshbfdserf.s3.eu-west-2.amazonaws.com/articles/advent-of-code-2023/day-6/wolfram-alpha.png)
