    ...
    <PageWidthContainer as="article">
      ...
      <PageContentContainer>
        ...
        <p>
          ...
          We are working with a string that represents an SVG and trying to transform it into a new format that better
          suits our use case. While find-and-replace was a valid solution for many of our requirements, in some cases we
          need to add attributes or leverage the DOM structure of the SVG. Cheerio allows us to parse the string into a
