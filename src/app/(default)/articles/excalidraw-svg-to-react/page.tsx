        ...
        <ArticleStyles>
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div>
              ...
              <ul className="mb-4 list-disc pl-4">
                <li>
                  The SVG contains font face information for fetching the Excali web font, this is not required as I
                  install the font directly and apply it via tailwind
                </li>
                <li>
                ...
                <li>
                  The SVG size is specific to the exact width and height within Excalidraw, we want to make the SVG fit
                ...
                <li>
                  The SVG has no interactivity - no opportunity to expand a section to learn more, clicking a section
                  should open a modal
                </li>
          ...
          <div>
            <ul className="mb-4 list-disc pl-4">
              ...
              <li>
                With these 2 assumptions we can select all our rectangle paths, all our arrow paths, all our text,
                correctly identify what text is found within a rectangle.
              </li>
            </ul>
          </div>
          ...
          <p>
            ...
            with their camelCase equivalents. There is no discrimination between whether the text, such as{' '}
            <code>stroke-width</code>, is being used as an attribute in an SVG element or is part of the visible text
            content that should remain unchanged. Therefore we could inadvertently alter the text content, for my
            situation I know this will not occur and the solution is practical.
          </p>
          <p>
            There is also a reliance on the external package <a href="https://www.npmjs.com/package/cheerio">cheerio</a>
            . We are working with a string that represents an SVG and trying to transform it into a new format that
            better suits our use case. While find-and-replace was a valid solution for many of our requirements, in some
            cases we need to add attributes or leverage the DOM structure of the SVG. Cheerio allows us to parse the
            string into a format that lets us use jQuery-style selectors to modify the SVG as if it were a DOM element.
            Once our transformations are complete, we convert the object back into a string representation of the SVG.
          </p>
          <Form />
        </ArticleStyles>
      </PageContentContainer>
