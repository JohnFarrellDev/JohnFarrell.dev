  ...
  return (
    <InputOptionContainer>
      <div className="flex w-full">
        <input
          type="checkbox"
          className="accent-primary-800 absolute h-6 w-6"
...
function InputOptionContainer({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-primary-600 relative flex flex-col gap-2 border border-dashed px-4 py-2">{children}</div>
  );
}
